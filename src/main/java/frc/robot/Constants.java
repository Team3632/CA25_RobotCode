...
public class Constants {
  ...
  public static class Elevator {
    ...
    public static final int kElevatorRightMotorId = 8;
  ...
  public static class Coral {
    public static final int kLeftMotorId = 21;//updated to match our architecture
    public static final int kRightMotorId = 23;//updated to match our architecture
  ...
  public static class Algae {
    // WRIST
    public static final int kWristMotorId = 22; //updated to match our architecture
    public static final int kIntakeMotorId = 20;   //updated to match our architecture

    public static final int kWristEncoderId = 0;    //this is a DIO input for the through bore Encoder
    ...
    public static final double kStowAngle = 155.0;
